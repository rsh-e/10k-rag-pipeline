...
DROP_IDS = {
    ...
    # Make room for table / multi-table finance items (102 - 12 + 10 = 100).
    "amd-rev-2025",
    "goog-rev-2025",
    "meta-rev-2025",
    "ko-nrev-2025",
...
NEW_ITEMS = [
    ...
    # Same-doc multi-table: income statement + balance sheet (year-mix / cash vs cash+STI).
    {
        "id": "amd-table-is-bs",
        ...
        "primary": ["4ce83490fdd992ff", "bd6654dc9a799a7f"],
        "equivalent": [],
    },
    # Same-doc multi-table: product-mix revenue vs segment operating income (2024 column is first).
    {
        "id": "goog-table-cloud",
        ...
        "primary": ["4f697bfc6ab78aa2", "e5370fce4ef82580"],
        "equivalent": [],
    },
    # Same-doc multi-table: FoA/RL revenue mix vs Reality Labs operating loss.
    {
        ...
        "primary": ["5942a02ac940b5b5", "5fdffb5d722bdb09"],
        "equivalent": [],
    },
    # Same-doc multi-table: dollar segment revenue vs percent-of-revenue operating income.
    {
        ...
        "primary": ["bce19a3257348e88", "9ecd1cd4448a9ce6"],
        "equivalent": [],
    },
    # Same-doc multi-table: Lower 48 segment vs consolidated sales.
    {
        ...
        "primary": ["199034f797c17bbe", "70e1fc5b579122da"],
        "equivalent": [],
    },
    # Same-doc multi-table: non-interest revenue line vs year-end cash.
    {
        ...
        "primary": ["d8a9027b05b1028a", "d6d28df7ea22ef75"],
        "equivalent": [],
    },
    # Single table, two franchises + currency vs operations change.
    {
        ...
        "primary": ["907ed41b690494fa"],
        "equivalent": [],
    },
    # Cross-doc tables: calendar AMD vs fiscal NVIDIA; millions; total vs Compute.
    {
        ...
        "primary": ["4ce83490fdd992ff", "bce19a3257348e88"],
        "equivalent": [],
    },
    # Cross-doc tables: KO geographic NOR total vs PEP consolidated net revenue.
    {
        ...
        "primary": ["41a999d3072ac951", "6f0c09785530846b"],
        "equivalent": [],
    },
    # Cross-doc tables: CVX sales declined vs COP sales rose; do not swap the two E&Ps.
    {
        ...
        "primary": ["6ce06288aab4e628", "70e1fc5b579122da"],
        "equivalent": [],
    },
]
